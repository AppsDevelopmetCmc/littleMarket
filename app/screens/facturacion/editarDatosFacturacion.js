...
export default function DatosFacturacion(props) {
    ...
    const [correoUsuario, setcorreoUsuario] = useState(props.route.params.factura.correo);
    const [cedulaUsuario, setcedulaUsuario] = useState(props.route.params.factura.numDocumento);
    const [telefonoUsuario, settelefonoUsuario] = useState(
        props.route.params.factura.telefono
    );
    const [tipoDocumento, settipoDocumento] = useState(props.route.params.factura.tipoDocumento);
