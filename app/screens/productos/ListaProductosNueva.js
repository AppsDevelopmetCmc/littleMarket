...
import { ItemProductoNuevo } from './ItemProductoNuevo';
...
export class ListaProductosNueva extends Component {
   constructor(props) {
      super(props);
      this.state = {
         listaProductos: [],
      ...
      global.categoria = 'V';
      global.pintarListaPoductos = this.pintarLista;
   }

   pintarLista = () => {
      this.setState({ listaProductos: global.productos.get(global.categoria) });
   };
   componentDidMount() {
